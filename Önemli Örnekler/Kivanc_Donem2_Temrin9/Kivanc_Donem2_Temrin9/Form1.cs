...
namespace Kivanc_Donem2_Temrin9
{
    public partial class Form1 : Form
    {
        ...
        DateTime ilktarih,ikincitarih;
        int ogno,dersno;
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == "")
            { MessageBox.Show("Lütfen Numara Giriniz"); }
            else { ogno = Convert.ToInt32(textBox1.Text); }
        ...
        {
            if (comboBox1.Text == "") { MessageBox.Show("Lütfen Ders Seçiniz"); }
            else { dersno = comboBox1.SelectedIndex; }
        ...
        {
            ikincitarih = dateTimePicker1.Value;
